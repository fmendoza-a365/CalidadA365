...
{
    protected $fillable = [
        'interaction_id', 'form_version_id', 'campaign_id', 'agent_id',
        'type', 'evaluator_id',
        'total_score', 'max_possible_score', 'percentage_score', 'status',
        'ai_processed_at', 'visible_to_agent_at', 'agent_viewed_at', 'finalized_at',
        'ai_prompt', 'ai_raw_response', 'ai_summary',
    ];
