<x-app-layout>
    ...
    <div class="form-container">
        <div class="form-card">
            <div class="form-body">
                <form method="POST" action="{{ route('transcripts.store') }}" enctype="multipart/form-data" class="form-section">
                    @csrf

                    <div class="form-row" x-data="{ selectedCampaign: '' }">
                        ...
                        x-init="$watch('$parent.selectedCampaign', (val) => {
                            ...
                            <p class="text-xs text-gray-500 mt-1">Si seleccionas una ficha específica, la IA usará esos criterios. Si lo dejas vacío, usará la ficha activa de la campaña.</p>
                    ...
                    <div class="form-group" x-data="fileUploader()">
                        <label for="transcript_files" class="form-label">Archivos de Transcripción <span class="text-rose-500">*</span></label>
                        
                        <!-- Drop Zone -->
                        <div 
                            class="mt-2 border-2 border-dashed rounded-xl p-8 text-center transition-colors cursor-pointer"
                        ...
                        >
                            ...
                            <p class="mt-3 text-sm text-gray-600 dark:text-gray-400">
                                <span class="font-semibold text-indigo-600 dark:text-indigo-400">Clic para seleccionar</span> o arrastra archivos aquí
                            </p>
                            <p class="mt-1 text-xs text-gray-500">Archivos .txt, máximo 5MB cada uno</p>
                        ...
                        <div class="mt-4 space-y-2" x-show="files.length > 0">
                            <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">Archivos Seleccionados:</h4>
                                ...
                                <template x-for="(file, index) in files" :key="index">
                                    <li class="flex items-center justify-between py-2 text-sm">
                                        <div class="flex items-center">
                                            ...
                                            <span class="ml-2 text-xs text-gray-400" x-text="formatSize(file.size)"></span>
                                        </div>
                                        <button type="button" @click="removeFile(index)" class="text-rose-500 hover:text-rose-700">
                    ...
                    <div class="alert alert-info">
                        ...
                        <span>Las transcripciones serán evaluadas automáticamente por nuestra IA.</span>
                    </div>
