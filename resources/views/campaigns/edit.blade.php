                ...
                <div
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            <input type="color" name="color" id="color" value="{{ old('color', $campaign->color) }}"
                ...
                <div
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="type" id="type" class="form-select">
                            <option value="Inbound" {{ old('type', $campaign->type) == 'Inbound' ? 'selected' : '' }}>
                                Inbound (Entrante)</option>
                            <option value="Outbound" {{ old('type', $campaign->type) == 'Outbound' ? 'selected' : '' }}>
                                Outbound (Saliente)</option>
                            <option value="Blended" {{ old('type', $campaign->type) == 'Blended' ? 'selected' : '' }}>
                                Blended (Híbrida)</option>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="form-group">
                            ...
                            <div class="relative">
                                <input type="number" name="target_quality" id="target_quality"
                                    value="{{ old('target_quality', $campaign->target_quality) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="target_aht" id="target_aht"
                                value="{{ old('target_aht', $campaign->target_aht) }}" class="form-input" min="0">
                ...
                <div
                    ...
                    <div class="form-group mb-6">
                        ...
                        <input type="url" name="script_url" id="script_url"
                            value="{{ old('script_url', $campaign->script_url) }}" class="form-input"
