                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            <input type="color" name="color" id="color" value="{{ old('color', '#4F46E5') }}" class="h-10 w-20 p-1 rounded border border-gray-300 dark:border-gray-600 cursor-pointer">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                     <div class="form-group mb-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" 
                            class="form-input" placeholder="Ej: Ventas Tarjetas" required>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="type" id="type" class="form-select">
                            <option value="Inbound" {{ old('type') == 'Inbound' ? 'selected' : '' }}>Inbound (Entrante)</option>
                            <option value="Outbound" {{ old('type') == 'Outbound' ? 'selected' : '' }}>Outbound (Saliente)</option>
                            <option value="Blended" {{ old('type') == 'Blended' ? 'selected' : '' }}>Blended (Híbrida)</option>
                            <option value="Backoffice" {{ old('type') == 'Backoffice' ? 'selected' : '' }}>Backoffice / Administrativo</option>
                            <option value="Chat/Email" {{ old('type') == 'Chat/Email' ? 'selected' : '' }}>Digital (Chat/Email/Redes)</option>
                        </select>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="form-group">
                            ...
                            <div class="relative">
                                <input type="number" name="target_quality" id="target_quality" value="{{ old('target_quality', 90) }}" 
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" rows="3" 
                            class="form-textarea" placeholder="Detalles extra sobre la campaña...">{{ old('description') }}</textarea>
