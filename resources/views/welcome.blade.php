...
<body class="bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100">
    ...
    <style>
        ...
        .qa-logo:hover .logo-part.blue {
            fill: var(--qa-blue) !important;
            filter: drop-shadow(0 0 12px rgba(45, 87, 146, 0.5));
        }

        .qa-logo:hover .logo-part.red {
            fill: var(--qa-red) !important;
            filter: drop-shadow(0 0 12px rgba(196, 9, 15, 0.5));
        }

        /* Enfoque y escala adicional al pasar el cursor sobre un trazo específico */
        .qa-logo .logo-part.blue:hover {
            transform: scale(1.07);
            filter: drop-shadow(0 0 16px rgba(45, 87, 146, 0.7)) !important;
            z-index: 10;
        }

        .qa-logo .logo-part.red:hover {
            transform: scale(1.07);
            filter: drop-shadow(0 0 16px rgba(196, 9, 15, 0.7)) !important;
            z-index: 10;
        }
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            if (stage) {
                for (let i = 0; i < 22; i++) {
                    ...
                    orb.className = 'orb';
                    orb.style.left = `${8 + Math.random() * 84}%`;
                    orb.style.top = `${60 + Math.random() * 26}%`;
                    orb.style.setProperty('--tx', `${-90 + Math.random() * 180}px`);
                    orb.style.animationDelay = `${Math.random() * 6}s`;
                    orb.style.animationDuration = `${4.8 + Math.random() * 3.8}s`;
