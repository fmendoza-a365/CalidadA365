                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="card p-6 text-center">
                            ...
                            <div class="relative inline-block group">
                                <div class="w-40 h-40 mx-auto rounded-full overflow-hidden bg-gray-100 dark:bg-gray-800 border-4 border-white dark:border-gray-700 shadow-xl">
                                    <img :src="photoPreview" class="w-full h-full object-cover">
                                </div>
                                <label for="profile_photo" class="absolute bottom-2 right-2 p-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full cursor-pointer shadow-lg transition-transform hover:scale-110">
                        ...
                        <div class="card p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="pt-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <input type="password" name="password" required class="form-input w-full mb-3" placeholder="••••••••">
                        ...
                        <div class="card p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="username" value="{{ old('username') }}" required class="form-input w-full font-mono bg-gray-50 dark:bg-gray-800" placeholder="jdoe">
                                </div>

                                <div>
                                    <label class="form-label">Nombres <span class="text-red-500">*</span></label>
                                    <input type="text" name="name" value="{{ old('name') }}" required class="form-input w-full" placeholder="Nombres del usuario">
                                </div>
                                
                                <div>
                                    <label class="form-label">Apellido Paterno <span class="text-red-500">*</span></label>
                                    <input type="text" name="paternal_surname" value="{{ old('paternal_surname') }}" required class="form-input w-full" placeholder="Apellido Paterno">
                                </div>

                                <div>
                                    <label class="form-label">Apellido Materno</label>
                                    <input type="text" name="maternal_surname" value="{{ old('maternal_surname') }}" class="form-input w-full" placeholder="Apellido Materno">
                                </div>
                        ...
                        <div class="card p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" required class="form-input w-full bg-gray-50 dark:bg-gray-800" placeholder="usuario@empresa.com">
                                </div>

                                <div>
                                    <label class="form-label">Email Personal</label>
                                    <input type="email" name="personal_email" value="{{ old('personal_email') }}" class="form-input w-full" placeholder="usuario@gmail.com">
                                </div>

                                <div>
                                    <label class="form-label">Teléfono/WhatsApp Empresa</label>
                                    <input type="text" name="company_phone" value="{{ old('company_phone') }}" class="form-input w-full" placeholder="999 000 000">
                                </div>

                                <div>
                                    <label class="form-label">Teléfono/WhatsApp Personal</label>
                                    <input type="text" name="personal_phone" value="{{ old('personal_phone') }}" class="form-input w-full" placeholder="999 000 000">
                                </div>

                                <div class="col-span-2">
                                    <label class="form-label">Dirección / Residencia</label>
                                    <input type="text" name="address" value="{{ old('address') }}" class="form-input w-full" placeholder="Av. Principal 123, Urb. Example">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-3">
                         <div class="fixed bottom-0 left-0 right-0 p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] flex justify-end gap-3 z-40 lg:pl-72">
                             ...
                             <button type="submit" class="btn-primary btn-md">Guardar Usuario</button>
                        </div>
