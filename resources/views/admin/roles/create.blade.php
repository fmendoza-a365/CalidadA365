    ...
    <div class="space-y-6">
        <form method="POST" action="{{ route('roles.store') }}">
            ...
            <div class="card mb-6">
                <div class="card-body p-6">
                    <div class="max-w-xl">
                        ...
                        <div class="mt-1">
                            <input type="text" name="name" id="name" required class="form-input w-full" placeholder="ej. Auditor Senior">
                        </div>
                        <p class="mt-2 text-sm text-gray-500">El nombre debe ser único (ej. auditor_senior).</p>
                    </div>
                </div>
            </div>

            <!-- Permissions Matrix -->
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Asignar Permisos Iniciales</h3>
            ...
            <div class="fixed bottom-0 left-0 right-0 p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] flex justify-end gap-3 z-40 lg:pl-72">
                 ...
                 <button type="submit" class="btn-primary btn-md">Crear Rol</button>
            </div>
