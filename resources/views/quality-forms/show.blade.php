                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex justify-between items-center text-sm font-medium">
                                <span class="text-gray-900 dark:text-white">Total Peso Atributos:</span>
                                <span class="{{ $qualityForm->latestVersion->formAttributes->sum('weight') == 100 ? 'text-green-600' : 'text-red-600' }}">
                                    {{ $qualityForm->latestVersion->formAttributes->sum('weight') }}%
                                </span>
                            </div>
                            @if(abs($qualityForm->latestVersion->formAttributes->sum('weight') - 100) > 0.01)
                                <p class="text-xs text-red-500 mt-1">
                                    ¡Atención! La suma de los pesos debe ser exactamente 100%.
                                </p>
                            @endif
                        </div>
                    </div>
